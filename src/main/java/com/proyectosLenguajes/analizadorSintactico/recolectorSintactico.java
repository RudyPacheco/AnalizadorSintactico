...
public class recolectorSintactico {
    ...
    public void recolectar(String tipoToken, Tokens token) {
            ...
            if (tokenGuia == null) {
                ...
                if (tokenGuia.equals("ESCRIBIR")) {
                    ...
                    if (tipoToken.equals("FIN")) {
                        ...
                        cadea =quitarComillas( token.getLexema());
                    }
                    ...
                    if (tipoToken.equals("Literal")) {
                        ...
                        cadenas.add(quitarComillas(token.getLexema()));
                    }
                    //X
    ...
    public void archivoSalida(){
            ...
            if (archivo.getName().endsWith("txt")) {
                String documentoS =this.documento;
